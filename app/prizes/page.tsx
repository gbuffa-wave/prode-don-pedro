...
const WEEKLY_WINNERS = [
  { week: "Semana 1", dateRange: "11 - 17 Jun", name: "Jugador 3", avatar_url: null as string | null, points: 85 },
  { week: "Semana 2", dateRange: "18 - 24 Jun", name: "Jugador 12", avatar_url: null as string | null, points: 78 },
  { week: "Semana 3", dateRange: "25 Jun - 1 Jul", name: "Jugador 1", avatar_url: null as string | null, points: 92 },
];

const DAILY_TOP = [
  { date: "Sab 14 Jun", name: "Jugador 1", avatar_url: null as string | null, points: 30 },
  { date: "Vie 13 Jun", name: "Jugador 7", avatar_url: null as string | null, points: 26 },
  { date: "Lun 16 Jun", name: "Jugador 3", avatar_url: null as string | null, points: 25 },
];
